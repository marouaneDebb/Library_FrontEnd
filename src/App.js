...
import ProfileAdherent from './pages/profileAdherent';
function App() {
  return (
    <Router>
      <Routes>
        ...
        <Route path="/:id/profile" element={<ProtectedRoute element={<ProfileAdherent />} role={["adherent"]} />} />
        ...
        <Route path="/:id/mesprets" element={<ProtectedRoute element={<AdherentPrets />} role={["adherent"]} />} />
